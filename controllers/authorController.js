...
export const author_create_post = [
   ...
   asyncHandler(async (req, res, next) => {
      ...
      // Create Author object with escaped and trimmed data, but without _id
...
export const author_update_post = [
   ...
   asyncHandler(async (req, res, next) => {
      ...
      if (!errors.isEmpty()) {
         ...
         await Author.findByIdAndUpdate(req.params.id, author); // Redirect to the author detail page.
         res.redirect(author.url);
      }
   }),
];
